...
% Optional
\mysubtitle{Machbarkeitsanalyse}
% Version
% \myteacher{}
\myversion{0.1}
...
\hline \rowcolor{gray} \textbf{\color{white}Version} & \textbf{\color{white}Autor} & \textbf{\color{white}QS} & \textbf{\color{white}Datum} & \textbf{\color{white}Status} & \textbf{\color{white}Kommentare} \\ 
 \hline \hline
0.1 & ldehner & mbeier & 2020-09-24 & Draft & \\ \hline 
...
\clearpage
\section{plattformunabhängige und responsive Webapplikation}
\include{chapters/_ldehner}
\section{Schnittstellen im Frontend}
\include{chapters/_rfoster}
\section{Backend mit Schnittstellen zu Frontend und Diensten}
