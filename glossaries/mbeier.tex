...
\newglossaryentry{xml}{
	name={XML},
	description={XML (Extensible Markup Language) ist eine Markup-Sprache, die zur Beschreibung von Daten genutzt wird. Wobei die Datenstruktur von XML über ein Schema verifiziert werden kann.\cite{xmlStandard}}
}
